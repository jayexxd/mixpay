"""
Django settings for mixpay project.
...
SECRET_KEY = 'zev#mtc&tlye#m%2whoi7(ikc+k2kioq^2###by&(&(9b7ah81'
...
WSGI_APPLICATION = 'mixpay.wsgi.application'
